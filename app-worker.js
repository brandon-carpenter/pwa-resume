...
// PWA
// -----------------------------------------------------------------------------
const cacheName = "app-" + "b71fbfdd94bb11883ef98cdbbe9bb370c1a034dc";
const resourcesToCache = ["/pwa-resume/web/icon.png","/pwa-resume/web/app.wasm","/pwa-resume/wasm_exec.js","/pwa-resume/manifest.webmanifest","/pwa-resume/app.js","/pwa-resume/app.css","/pwa-resume"];

self.addEventListener("install", async (event) => {
  try {
    console.log("installing app worker b71fbfdd94bb11883ef98cdbbe9bb370c1a034dc");
    await installWorker();
...
self.addEventListener("activate", async (event) => {
  try {
    ...
    console.log("app worker b71fbfdd94bb11883ef98cdbbe9bb370c1a034dc is activated");
  } catch (error) {
