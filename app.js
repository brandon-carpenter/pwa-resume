...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/pwa-resume","GOAPP_STATIC_RESOURCES_URL":"/pwa-resume/web","GOAPP_VERSION":"b71fbfdd94bb11883ef98cdbbe9bb370c1a034dc"};
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("/pwa-resume/web/app.wasm", showProgress),
      go.importObject
    );
